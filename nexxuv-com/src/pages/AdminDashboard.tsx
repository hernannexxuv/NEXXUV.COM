...
import { ArrowLeft, RefreshCw, Clock, CheckCircle, Calendar, ChevronDown, ChevronUp, Building2, Mail, Phone, User, MessageSquare, CreditCard as Edit3, Save, X, Search, Filter } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#030712] px-6 py-10">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {([
            { key: 'all', label: 'Total Solicitudes', color: 'text-white', border: 'border-gray-700/40' },
            { key: 'pending', label: 'En Recepción', color: 'text-amber-400', border: 'border-amber-500/20' },
            { key: 'under_review', label: 'En Análisis', color: 'text-cyan-400', border: 'border-cyan-500/20' },
            { key: 'scheduled', label: 'Agendadas', color: 'text-emerald-400', border: 'border-emerald-500/20' },
